...
export const MobileNav = () => {
  return (
    <nav className="flex fixed tablet:hidden bottom-0 py-2 w-full bg-background1 border-t border-accent rounded-md items-center justify-evenly translate-x-[-1rem] z-10">
      <MobileNavItem href="/">
